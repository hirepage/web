<script>
  export default {
    asyncData ({ redirect }) {
      redirect('https://www.producthunt.com/upcoming/otechie-2')
      //
      ...
      // redirect(`https://slack.com/oauth/v2/authorize?client_id=${process.env.SLACK_ID}&scope=${scope}&user_scope=${userScope}&redirect_uri=${encodeURIComponent(process.env.WEB_URL)}/connect/slack`)
    }
  }
</script>
